...
public class Player extends MoveableBody{
    ...
    public void moveToward(double[] velocity) {
        ...
        camera.setLayoutX((Sprite.getCenterX() + velocity[0]) - HelloApplication.getScreenWidth() / 2 * camera.getScaleX());
        camera.setLayoutY((Sprite.getCenterY() + velocity[1])  - HelloApplication.getScreenHeight() / 2 * camera.getScaleY());
    }


    public void gameOver(){
        World.queueFree(Sprite);
    }
