...
public class Enemy extends MoveableBody{
    ...
    Enemy(Group group, double initialSize){
        ...
        Sprite.setCenterX((Math.random() * World.getMapLimitWidth() * 2) - World.getMapLimitWidth());
        Sprite.setCenterY((Math.random() * World.getMapLimitHeight() * 2) - World.getMapLimitHeight());
